          ...
          <Link href='/product/wera-the-code' className="lg:w-1/4 md:w-1/2 p-4 w-full">
           <div >
            <div className="block relative h-70 rounded overflow-hidden">
              <img alt="ecommerce" className="object-contain object-center w-full h-full block hoodie" src="https://www.triumph-sports.com/wp-content/uploads/2019/12/30-1.png" />
            </div>
            <div className="mt-4">
